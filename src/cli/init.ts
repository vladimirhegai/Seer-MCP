...
function agentsBlock(): string {
  return [
    ...
    '## Seer',
    '',
    'Seer shows what an edit will touch: symbols, callers, tests, routes,',
    'boundaries, risk, and per-symbol git history. Reach for the `seer_*` MCP',
    'tools BEFORE `rg`, file reads, or broad search whenever a task touches code',
    'structure. They cost fewer tokens and round-trips than searching by hand.',
    'Every tool self-describes its full',
